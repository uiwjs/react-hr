import{j as e,r as k,R as g,c as I}from"./react-vendor-vCJmeiA8.js";import{_ as f,a as H,c as R,M as N}from"./markdown-vendor-C-xtZLkx.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();const D="#d0d0d5",q="#a2a9b6",z="1.25rem",E=(a,t)=>typeof a=="number"?`${a}px`:a??t,L=a=>`url("data:image/svg+xml,${encodeURIComponent(a)}")`,V=a=>L(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="8" viewBox="0 0 16 8"><path d="M0 4 Q4 0 8 4 T16 4" fill="none" stroke="${a}" stroke-width="1.4"/></svg>`),W=(a,t)=>[...(t?["calc(50% - 24px)","50%","calc(50% + 24px)"]:["50%"]).map(i=>`linear-gradient(45deg, transparent calc(50% - 5px), ${a} calc(50% - 5px) calc(50% + 5px), transparent calc(50% + 5px)) ${i} 50% / 12px 12px no-repeat`),`linear-gradient(${a}, ${a}) center / 100% 1px no-repeat`].join(", "),K=(a,t)=>[...(t?["calc(50% - 24px)","50%","calc(50% + 24px)"]:["50%"]).map(i=>`radial-gradient(circle at center, ${a} 0 6px, transparent 6.5px) ${i} 50% / 14px 14px no-repeat`),`linear-gradient(${a}, ${a}) center / 100% 1px no-repeat`].join(", ");function s({variant:a="solid",color:t=D,accentColor:r=q,content:i,multiple:n,dashedFilled:o,dashedOpen:c,margin:p,style:h,...l}){const x=E(p,z),w=E(o,"4px"),S=E(c,"6px"),y={boxSizing:"border-box",border:0,margin:`${x} 0`},P={solid:{borderTop:`1px solid ${t}`},dotted:{borderTop:`1px dotted ${r}`},dotted2:{borderTop:`2px dotted ${r}`},dashed:{borderTop:`1px dashed ${r}`},dashed2:{borderTop:`2px dashed ${r}`},double:{borderTop:`3px double ${t}`},"dashed-fixed":{height:1,background:`repeating-linear-gradient(to right, ${r} 0 ${w}, transparent 0 calc(${w} + ${S}))`},"edge-weak":{height:1,background:`linear-gradient(to right, transparent, ${t}, transparent)`},twill:{height:6,background:`repeating-linear-gradient(135deg, ${r} 0px, ${r} 1px, transparent 1px, transparent 6px)`},"twill-colorful":{height:6,background:"linear-gradient(135deg, red, orange, green, blue, purple)",WebkitMaskImage:"repeating-linear-gradient(135deg, #000 0px, #000 1px, transparent 1px, transparent 6px)",maskImage:"repeating-linear-gradient(135deg, #000 0px, #000 1px, transparent 1px, transparent 6px)"},wavy:{height:8,backgroundImage:V(t),backgroundRepeat:"repeat-x",backgroundPosition:"center",backgroundSize:"16px 8px"},shadow:{borderTop:"1px solid rgb(0 0 0 / 10%)",boxShadow:`inset 0 10px 10px -10px ${t}`,paddingTop:10},"mid-circle":{height:14,background:K(t,n)},"mid-square":{height:16,background:W(t,n)},"space-square":{height:16,background:[`linear-gradient(45deg, transparent calc(50% - 5px), ${t} calc(50% - 5px) calc(50% + 5px), transparent calc(50% + 5px)) left 50% / 12px 12px no-repeat`,`linear-gradient(45deg, transparent calc(50% - 5px), ${t} calc(50% - 5px) calc(50% + 5px), transparent calc(50% + 5px)) right 50% / 12px 12px no-repeat`,`linear-gradient(${t}, ${t}) center / calc(100% - 32px) 1px no-repeat`].join(", ")},"double-arrow":{height:10,marginLeft:20,marginRight:20,background:[`linear-gradient(45deg, transparent 0 5px, ${t} 5px 7px, transparent 7px) left center / 12px 12px no-repeat`,`linear-gradient(225deg, transparent 0 5px, ${t} 5px 7px, transparent 7px) right center / 12px 12px no-repeat`,`linear-gradient(${t}, ${t}) center calc(50% - 2px) / 100% 1px no-repeat`,`linear-gradient(${t}, ${t}) center calc(50% + 2px) / 100% 1px no-repeat`].join(", ")},"solid-content":{},"dashed-content":{},"fade-content":{},"mid-border-content":{}};if(a.endsWith("content")){const _={...y,flex:1,margin:0,borderTop:a==="dashed-content"?`1px dashed ${t}`:a==="fade-content"?0:`1px solid ${t}`,height:a==="fade-content"?1:void 0,background:a==="fade-content"?`linear-gradient(to right, transparent, ${t}, transparent)`:void 0,...h},B={color:a==="mid-border-content"?"transparent":r,border:a==="mid-border-content"?`1px solid ${t}`:void 0,padding:a==="mid-border-content"?"4px 1ch":"0 1ch",fontSize:12,lineHeight:"1.2",whiteSpace:"nowrap"};return e.jsxs("span",{style:{display:"flex",alignItems:"center",gap:0,margin:`${x} 0`,width:"100%"},children:[e.jsx("hr",{...l,style:_}),e.jsx("span",{"aria-hidden":"true",style:B,children:i}),e.jsx("hr",{"aria-hidden":"true",style:_})]})}return e.jsx("hr",{...l,style:{...y,...P[a],...h}})}function Q(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsx(s,{variant:"solid"})]})}function U(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"dotted"}),e.jsx(s,{variant:"dotted2"})]})}function G(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"dashed"}),e.jsx(s,{variant:"dashed2"})]})}function X(){return e.jsx(s,{variant:"double"})}function J(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"dashed-fixed"}),e.jsx(s,{variant:"dashed-fixed",dashedFilled:6,dashedOpen:5}),e.jsx(s,{variant:"dashed-fixed",dashedFilled:12,dashedOpen:4})]})}function Y(){return e.jsx(s,{variant:"edge-weak"})}function Z(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"twill"}),e.jsx(s,{variant:"twill-colorful"})]})}function ee(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"wavy"}),e.jsx(s,{variant:"shadow"})]})}function te(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"mid-circle"}),e.jsx(s,{variant:"mid-square"}),e.jsx(s,{variant:"mid-circle",multiple:!0}),e.jsx(s,{variant:"mid-square",multiple:!0})]})}function ae(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"space-square"}),e.jsx(s,{variant:"double-arrow"})]})}function re(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"solid-content",content:"分隔线"}),e.jsx(s,{variant:"dashed-content",content:"虚线内容"}),e.jsx(s,{variant:"fade-content",content:"两端淡出"}),e.jsx(s,{variant:"mid-border-content",content:"边框内容"})]})}function ne(){return e.jsxs(e.Fragment,{children:[e.jsx(s,{color:"#1677ff"}),e.jsx(s,{variant:"dashed",accentColor:"#fa541c"}),e.jsx(s,{variant:"mid-circle",color:"#52c41a",multiple:!0}),e.jsx(s,{variant:"solid-content",content:"自定义颜色",color:"#722ed1",accentColor:"#722ed1"})]})}const ie=`<div markdown="1">
...
`,oe=[Q,U,G,X,J,Y,Z,ee,te,ae,re,ne],se=[`import { Hr } from '@uiw/react-hr';
